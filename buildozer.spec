...
requirements = python3,kivy==2.3.1,kivymd==2.0.1,nltk==3.6.7,pyttsx3==2.98,starlette==0.19.1,cython==0.29.36,sdl2_ttf=2.20.2 

requirements.source.numpy = pip
requirements.source.sympy = pip
...
# (list) List of build commands to run before the package generation
before_build = cd $BUILDOZER_PLATFORM_DIR/build/other_builds/kivy/armeabi-v7a__ndk_target_21/kivy && patch -p0 < $BUILDOZER_PROJECT_DIR/fix_kivy_sdl2.patch
